            ...
            <div className="my-3 mx-3 " >
                <Container className="" fluid >
                    ...
                    <CardGroup className="my-3 mx-3">
                        <Card className="text-center" style={{ width: '75%', opacity: 0.75 }}>
                            <Carousel >
                                <Carousel.Item className="carousel-slide img">
                                    <Card.Img variant="top" src={acrylicPic} style={{ height: '75vh', objectFit: 'contain', opacity: 1 }} />
                                </Carousel.Item>
                                <Carousel.Item className="carousel-slide img">
                                    <Card.Img variant="top" src={woodPic} style={{ height: '75vh', objectFit: 'contain', opacity: 1 }} />
                                </Carousel.Item>
                                <Carousel.Item className="carousel-slide img">
                                    <Card.Img variant="top" src={metalPic} style={{ height: '75vh', objectFit: 'contain', opacity: 1 }} />
                                </Carousel.Item>
                            </Carousel>
                            <Card.Body>
